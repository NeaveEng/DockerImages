...
left_img_pub = rospy.Publisher('stereo/left/image_raw', Image, queue_size=10)
right_img_pub = rospy.Publisher('stereo/right/image_raw', Image, queue_size=10)

left_cam_pub = rospy.Publisher('stereo/left/camera_info', CameraInfo, queue_size=10)
right_cam_pub = rospy.Publisher('stereo/right/camera_info', CameraInfo, queue_size=10)
...
for frame in camera.capture_continuous(stream, format="rgb", use_video_port=True):
    ...
    left_cam_info.header.frame_id = "left_camera"
    right_cam_info.header.frame_id = "right_camera"
